...
func main() {
	...
	micro.Route("/notes/search/title/:title", func(router fiber.Router) {
		router.Get("", controllers.SearchNotesByTitle)
	})


	micro.Route("/notes/search/content/:content", func(router fiber.Router) {
		router.Get("", controllers.SearchNotesByContent)
	})

	micro.Route("/notes/delete/:noteId", func(router fiber.Router) {
	...
	// app.Get("/notes/search/:title", controllers.SearchNotesByTitle)
